...
namespace CodeProjector_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(MarkRendle.CodeProjector.GuidList.guidCodeProjectorCmdSet, (int)MarkRendle.CodeProjector.PkgCmdIDList.cmdidProjectCode);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "CodeProjector", "MarkRendle.CodeProjector.CodeProjectorPackage");
