...
using MarkRendle.CodeProjector;

namespace CodeProjector_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new CodeProjectorPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(MarkRendle.CodeProjector.GuidList.guidCodeProjectorCmdSet, (int)MarkRendle.CodeProjector.PkgCmdIDList.cmdidProjectCode);
